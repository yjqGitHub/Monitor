...
namespace JQ.MQ.RabbitMQ
{
    ...
    public sealed class RabbitMQClient : JQDisposable, IMQClient
    {
        ...
        public void Subscribe<T>(Action<T> actionHandle, Action<T, Exception> errorActionHandle = null, string routingKey = null, string memberName = null, string loggerName = null, Type loggerType = null)
        {
            var mqAttribute = MQAttribute.GetMQAttribute<T>();
            routingKey.IsNotNullAndNotWhiteSpaceThenExcute(() => mqAttribute.RoutingKey = routingKey);
        ...
        /// <param name="loggerName">记录器名字</param>
        /// <param name="loggerType">记录器类型</param>
        public void Pull<T>(Action<T> actionHandle, Action<T, Exception> errorActionHandle = null, string routingKey = null, string memberName = null, string loggerName = null, Type loggerType = null)
        {
            var mqAttribute = MQAttribute.GetMQAttribute<T>();
            routingKey.IsNotNullAndNotWhiteSpaceThenExcute(() => mqAttribute.RoutingKey = routingKey);
            CreateExchangeAndQueue(mqAttribute, isConsumer: true);
        ...
        /// <param name="loggerName">记录器名字</param>
        /// <param name="loggerType">记录器类型</param>
        public void RpcServer<T>(Func<T, T> handler, string routingKey = null, string memberName = null, string loggerName = null, Type loggerType = null)
        {
            var mqAttribute = MQAttribute.GetMQAttribute<T>();
            mqAttribute.NotNull("MQAttribute不能为空");
            routingKey.IsNotNullAndNotWhiteSpaceThenExcute(() => mqAttribute.RoutingKey = routingKey);
