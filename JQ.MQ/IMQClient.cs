...
namespace JQ.MQ
{
    ...
    public interface IMQClient
    {
        ...
        void Subscribe<T>(Action<T> actionHandle, Action<T, Exception> errorActionHandle = null, string routingKey = null, string memberName = null, string loggerName = null, Type loggerType = null);
        ...
        /// <param name="loggerName">记录器名字</param>
        /// <param name="loggerType">记录器类型</param>
        void Pull<T>(Action<T> actionHandle, Action<T, Exception> errorActionHandle = null, string routingKey = null, string memberName = null, string loggerName = null, Type loggerType = null);
        ...
        /// <param name="loggerName">记录器名字</param>
        /// <param name="loggerType">记录器类型</param>
        void RpcServer<T>(Func<T, T> handler, string routingKey = null, string memberName = null, string loggerName = null, Type loggerType = null);
